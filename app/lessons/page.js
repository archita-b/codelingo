        ...
        {lessons?.map((lesson) => {
          return (
            <Link
              ...
              className={`flex justify-center flex-col items-center rounded-xl border-x-2 border-t-2 border-b-4 border-neutral-400 text-neutral-500 font-semibold text-2xl hover:bg-neutral-200`}
            >
              Lesson {lesson.id}
            </Link>
          );
